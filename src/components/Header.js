...
export default function Header2() {
  ...
  return (
    <>
      ...
      <div className=" min-h-screen pt-8 mb-0 flex items-center border-solid border-2 border-primary justify-center bg-primary"  >
        ...
        <div className=" p-8 max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 ">
          ...
          >
            Hi! <br />
          I'm <span className='text-gray-200'>He</span>{content.header.text[1]} <span className='text-gray-200'>Ro</span>{content.header.text[2]}
          </h2>
          ...
          >
            ...
            />
            {/* <hr className='w-3/5 md:text-center' /> */}
          </h1>
