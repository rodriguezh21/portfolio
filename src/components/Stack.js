    ...
    <>
      <div className='min-h-full font-serif' id='stack'>
        <div className='bg-primary pb-48'>
          <header className='py-20 border-solid border-2 border-primary '>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              <h1 className='text-3xl font-bold text-center text-tertiary uppercase'>
                What I do
              </h1>
            </div>
          </header>
          ...
          <div className='max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 pb-48'>
            <ul className= 'relative group grid grid-cols-1 gap-4 sm:w-auto sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
              {content.projects.map(project => (
                <li
                  key={project.title}
                  className=' transform transition duration-500 ease-in-out hover:animate-bounce hover:-translate-y-3 hover:-skew-x-2  hover:bg-tertiary col-span-1 flex flex-col text-center md:text-center bg-gray-100 rounded-lg shadow hover:shadow-lg divide-y divide-gray-200 overflow-hidden'
                >
                  ...
                  <div className='flex-1 flex flex-col p-8'>
                    ...
                    <dl className='mt-1 flex-grow flex flex-col justify-between'>
                      ...
                      <dd className='mt-3'>
                        <span className=' py-1 text-gray-700 text-xs sm:text-lg font-medium'>
                          {project.tools}
                        </span>
                      </dd>
                    </dl>
